...
import com.kevinberg.kontespringboot.backend.entity.*;
...
public class ResetService {
    ...
    //always when you "inject" entitymanager, why not autowired here
    // but persistenccontext? is it becuase its a test class?
    @PersistenceContext

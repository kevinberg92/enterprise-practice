...
import com.kevinberg.kontespringboot.backend.StubApplication;
import com.kevinberg.kontespringboot.backend.entity.Quiz;
import com.kevinberg.kontespringboot.backend.services.CategoryService;
...
public class QuizServiceTest extends ServiceTestBase{
    ...
    public void testNoQuiz(){
        ...
        assertEquals(0, quizService.getAllQuizzes().size());
    }

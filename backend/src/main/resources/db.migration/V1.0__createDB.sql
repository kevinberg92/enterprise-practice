...
create table quiz (id bigint generated by default as identity, first_answer varchar(128) not null, fourth_answer varchar(128) not null, correct_answer integer not null check (correct_answer>=0 AND correct_answer<=3), question varchar(128) not null, second_answer varchar(128) not null, third_answer varchar(128) not null, sub_category_id bigint not null, primary key (id));
